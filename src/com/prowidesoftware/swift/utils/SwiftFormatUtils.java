 ...
 * 		<li>TIME3 HH[mm]
 * 		<li>BOOL Y/N
 * 		<li>DATETIME YYYYMMDDHHMM
 * 		<li>DATETIME with short year YYMMDDHHMM
 * 		<li>DAYTIME DDHHMM
 * 		<li>MONTHDAY MMDD
 * 		<li>MIR
 * 		<li>MOR
 ...
 * @since 6.0
 * @version $Id: SwiftFormatUtils.java,v 1.5 2014/05/02 20:13:42 sebastian Exp $
 */
public class SwiftFormatUtils {
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(SwiftFormatUtils.class.getName());
