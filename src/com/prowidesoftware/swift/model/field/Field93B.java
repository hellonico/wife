...
public class Field93B extends Field implements Serializable , AmountContainer, GenericField {
	...
	*/
	...
	/**
	 * Get the BalanceAmount (component5).
	 * @return the BalanceAmount from component5
	 */
	...
	/**
	 * Get the BalanceAmount (component5) as Number
	 * @return the BalanceAmount from component5 converted to Number or <code>null</code> if cannot be converted
	 */
	...
	/**
	 * Set the BalanceAmount (component5).
	 * @param component5 the BalanceAmount to set
	 */
	...
	/**
	 * Set the BalanceAmount (component5) as Number
	 * @param component5 Number with the BalanceAmount content to set
	 */
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field93B	*/
	@Override
	...
	*/
	public static Field93B get(final SwiftTagListBlock block) {
		...
		return (Field93B) block.getFieldByName(NAME);
	}
