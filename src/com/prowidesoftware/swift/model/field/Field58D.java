...
public class Field58D extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field58D	*/
	@Override
	...
	*/
	public static Field58D get(final SwiftTagListBlock block) {
		...
		return (Field58D) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field58D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see 	 */ 
	public static java.util.List<Field58D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field58D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field58D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field58D> result = new java.util.ArrayList<Field58D>(arr.length);
			for (final Field f : arr) {
				result.add((Field58D) f);
			}
			return result;
		}
