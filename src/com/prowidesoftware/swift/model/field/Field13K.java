 ...
 * Field 13K<br /><br />
 *
 * validation pattern: :4!c//3!c/&lt;AMOUNT&gt;15<br />
...
public class Field13K extends Field implements Serializable , AmountContainer, GenericField {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field13K	*/
	@Override
	...
	*/
	public static Field13K get(final SwiftTagListBlock block) {
		...
		return (Field13K) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field13K in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see 	 */ 
	public static java.util.List<Field13K> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field13K from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field13K> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field13K> result = new java.util.ArrayList<Field13K>(arr.length);
			for (final Field f : arr) {
				result.add((Field13K) f);
			}
			return result;
		}
