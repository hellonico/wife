...
public class Field33F extends Field implements Serializable , CurrencyContainer, AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field33F	*/
	@Override
	...
	*/
	public static Field33F get(final SwiftTagListBlock block) {
		...
		return (Field33F) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field33F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see 	 */ 
	public static java.util.List<Field33F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field33F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field33F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field33F> result = new java.util.ArrayList<Field33F>(arr.length);
			for (final Field f : arr) {
				result.add((Field33F) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
