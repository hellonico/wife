...
public class Field60A extends Field implements Serializable , DateContainer, AmountContainer {
	private static final long serialVersionUID = 1L;
	/**
	 * Constant with the field name 60A
	 */
    public static final String NAME = "60A";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_60A = "60A";
	...
	*/
	 ...
	 */
	public Field60A setComponent1(String component1) {
	 ...
	 */
	public Field60A setDCMark(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field60A setComponent2(String component2) {
	 ...
	 */
	public Field60A setComponent2(java.util.Calendar component2) {
	 ...
	 */
	public Field60A setDate(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field60A setDate(java.util.Calendar component2) {
		setComponent(2, SwiftFormatUtils.getDate2(component2));
		return this;
	}
	 ...
	 */
	public Field60A setComponent3(String component3) {
	 ...
	 */
	public Field60A setCurrency(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field60A setComponent4(String component4) {
	 ...
	 */
	public Field60A setComponent4(java.lang.Number component4) {
	 ...
	 */
	public Field60A setAmount(String component4) {
		setComponent(4, component4);
		return this;
	}
	 ...
	 */
	public Field60A setAmount(java.lang.Number component4) {
		setComponent(4, SwiftFormatUtils.getNumber(component4));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field60A	*/
	@Override
	...
	*/
	public static Field60A get(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		return (Field60A) block.getFieldByName(NAME);
	}
	
	/**
	 * Get the first instance of Field60A in the given message.
	 * @param msg may be empty or null
	 * @returns null if not found or msg is empty or null
	 * @see 	 */
	public static Field60A get(final SwiftMessage msg) {
	...
	/**
	 * Get a list of all occurrences of the field Field60A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see 	 */ 
	public static java.util.List<Field60A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field60A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field60A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field60A> result = new java.util.ArrayList<Field60A>(arr.length);
			for (final Field f : arr) {
				result.add((Field60A) f);
			}
			return result;
		}
