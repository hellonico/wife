...
public class Field56B extends Field implements Serializable  {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field56B	*/
	@Override
	...
	*/
	public static Field56B get(final SwiftTagListBlock block) {
		...
		return (Field56B) block.getFieldByName(NAME);
	}
