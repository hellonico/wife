...
public class Field33D extends Field implements Serializable , CurrencyContainer, DateContainer, AmountContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field33D	*/
	@Override
	...
	*/
	public static Field33D get(final SwiftTagListBlock block) {
		...
		return (Field33D) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field33D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see 	 */ 
	public static java.util.List<Field33D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field33D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field33D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field33D> result = new java.util.ArrayList<Field33D>(arr.length);
			for (final Field f : arr) {
				result.add((Field33D) f);
			}
			return result;
		}
		return java.util.Collections.emptyList();
