...
public class Field30F extends Field implements Serializable , DateContainer {
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field30F	*/
	@Override
	...
	*/
	public static Field30F get(final SwiftTagListBlock block) {
		...
		return (Field30F) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field30F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see 	 */ 
	public static java.util.List<Field30F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field30F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field30F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field30F> result = new java.util.ArrayList<Field30F>(arr.length);
			for (final Field f : arr) {
				result.add((Field30F) f);
			}
			return result;
		}
