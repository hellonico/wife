...
public class Field50A extends Field implements Serializable , BICContainer {
	...
	*/
	 ...
	 */
	public Field50A setComponent2(com.prowidesoftware.swift.model.BIC component2) {
	 ...
	 */
	public Field50A setBIC(com.prowidesoftware.swift.model.BIC component2) {
		setComponent(2, SwiftFormatUtils.getBIC(component2));
		return this;
	}
   ...
   public String parserPattern() {
	...
	/**
	* @deprecated use constant Field50A	*/
	@Override
	...
	*/
	public static Field50A get(final SwiftTagListBlock block) {
		...
		return (Field50A) block.getFieldByName(NAME);
	}
	...
	/**
	 * Get a list of all occurrences of the field Field50A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see 	 */ 
	public static java.util.List<Field50A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return null;
	...
	/**
	 * Get a list of all occurrences of the field Field50A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field50A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return null;
		}
		final Field[] arr = block.getFieldsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field50A> result = new java.util.ArrayList<Field50A>(arr.length);
			for (final Field f : arr) {
				result.add((Field50A) f);
			}
			return result;
		}
