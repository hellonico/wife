...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT192.class.getName());
	...
	/**
	 * Creates an MT192 initialized with a new SwiftMessage
	 */
	/*
	public MT192() {
		super();
