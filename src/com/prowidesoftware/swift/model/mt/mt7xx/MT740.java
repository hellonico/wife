...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT740.class.getName());
	...
	/**
	 * Creates an MT740 initialized with a new SwiftMessage
	 */
	/*
	public MT740() {
		super();
	...
	*/
	...
	public Field40F getField40F() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("40F");
			if (t == null) {
