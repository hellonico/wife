...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT620.class.getName());
	...
	/**
	 * Creates an MT620 initialized with a new SwiftMessage
	 */
	/*
	public MT620() {
		super();
	...
	*/
	...
	public Field32R getField32R() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("32R");
			if (t == null) {
	...
	public Field34J getField34J() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("34J");
			if (t == null) {
	...
	public Field22Z getField22Z() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("22Z");
			if (t == null) {
	...
	public List<Field33J> getField33J() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("33J");
 ...
 */ 
	...
	public static class SequenceA extends SwiftTagListBlock {
		...
		*/
		...
		/**
		* Last mandatory tagname of the sequence: <em>"26C"  </em>
		* Array format is for cases when more than one letter options is allowed
		*/
		public static final String[] END = { "26C"   };
		/**
	...
	*/ 
	...
	public static class SequenceG1 extends SwiftTagListBlock {
		...
		* Array format is for cases when more than one letter options is allowed
		*/
		public static final String[] END = { "33B", "33J"   };
		/**
		* List of optional tags after the last mandatory tag
		*/
 	...
 	/**
	* Get the single occurrence of SequenceG1 delimited by {@value SequenceG1#START} and {@value SequenceG1#END} .
	* The presence of this methods indicates that this sequence can occur only once according to the Standard.
	* If block 4 is empty this method returns <code>null</code>.
	*/ 
	public SequenceG1 getSequenceG1() {
		...
		final SwiftBlock4 b4 = getSwiftMessage().getBlock4();
		if (b4 != null && !b4.isEmpty()) {
			final SwiftTagListBlock content = b4.getSubBlockDelimitedWithOptionalTail(SequenceG1.START, SequenceG1.END, SequenceG1.TAIL);
			if (log.isLoggable(java.util.logging.Level.FINE)) {
				if (content == null) {
	...
	public static class SequenceG2 extends SwiftTagListBlock {
		...
		* @see SwiftTagListBlock
		*/
		private SequenceG2(final SwiftTagListBlock content) {
			super(content.getTags());
		}
		/**
		* tagname of the first tag in the sequence which must be mandatory.
