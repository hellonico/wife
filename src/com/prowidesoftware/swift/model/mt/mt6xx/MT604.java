...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT604.class.getName());
	...
	/**
	 * Creates an MT604 initialized with a new SwiftMessage
	 */
	/*
	public MT604() {
		super();
 ...
 */ 
	...
	public static class Sequence_0 extends SwiftTagListBlock {
		...
		*/
		...
		/**
		* Last mandatory tagname of the sequence: <em>"88A", "88B", "88D"  </em>
		* Array format is for cases when more than one letter options is allowed
		*/
		public static final String[] END = { "88A", "88B", "88D"   };
		/**
