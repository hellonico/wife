...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT205COV.class.getName());
	...
	/**
	 * Creates an MT205COV initialized with a new SwiftMessage
	 */
	/*
	public MT205COV() {
		super();
