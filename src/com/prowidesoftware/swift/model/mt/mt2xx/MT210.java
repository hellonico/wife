...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT210.class.getName());
	...
	/**
	 * Creates an MT210 initialized with a new SwiftMessage
	 */
	/*
	public MT210() {
		super();
	...
	*/
	...
	public List<Field50> getField50() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("50");
