...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT204.class.getName());
	...
	/**
	 * Creates an MT204 initialized with a new SwiftMessage
	 */
	/*
	public MT204() {
		super();
	...
	*/
	...
	public List<Field53B> getField53B() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("53B");
			final List<Field53B> result = new ArrayList<Field53B>();
			for (int i=0; i<tags.length; i++) {
				result.add(new Field53B(tags[i].getValue()));
			}
			return result;
		}
	}
 ...
 */ 
	...
	public static class SequenceA extends SwiftTagListBlock {
		...
		*/
		public static final String[] TAIL = new String[]{ "57A", "57B", "57D", "58A", "58D", "72"   };
	...
	*/ 
	...
	public static class SequenceB extends SwiftTagListBlock {
		...
		*/
		public static final String[] START = { "20"   } ;
		/**
		* Last mandatory tagname of the sequence: <em>"53A", "53B", "53D"  </em>
		* Array format is for cases when more than one letter options is allowed
		*/
		public static final String[] END = { "53A", "53B", "53D"   };
		/**
		* List of optional tags after the last mandatory tag
		*/
