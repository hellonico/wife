...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT973.class.getName());
	...
	/**
	 * Creates an MT973 initialized with a new SwiftMessage
	 */
	/*
	public MT973() {
		super();
