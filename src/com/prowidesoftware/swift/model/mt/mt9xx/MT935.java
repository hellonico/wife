...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT935.class.getName());
	...
	/**
	 * Creates an MT935 initialized with a new SwiftMessage
	 */
	/*
	public MT935() {
		super();
	...
	*/
	...
	public List<Field37H> getField37H() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("37H");
