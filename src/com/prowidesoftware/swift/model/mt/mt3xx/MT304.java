...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT304.class.getName());
	...
	/**
	 * Creates an MT304 initialized with a new SwiftMessage
	 */
	/*
	public MT304() {
		super();
	...
	*/
	...
	public Field17O getField17O() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("17O");
			if (t == null) {
				log.fine("field 17O not found");
				return null;
			} else {
	 ...
	 * 
	 * @return a Field17N object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field17N getField17N() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag t = getSwiftMessage().getBlock4().getTagByName("17N");
			if (t == null) {
				log.fine("field 17N not found");
				return null;
			} else {
	...
	public List<Field21P> getField21P() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("21P");
			final List<Field21P> result = new ArrayList<Field21P>();
			for (int i=0; i<tags.length; i++) {
				result.add(new Field21P(tags[i].getValue()));
			}
			return result;
		}
	}
	...
	public List<Field17G> getField17G() {
		...
		if (getSwiftMessage().getBlock4() == null) {
			...
			final Tag[] tags = getSwiftMessage().getBlock4().getTagsByName("17G");
			final List<Field17G> result = new ArrayList<Field17G>();
			for (int i=0; i<tags.length; i++) {
				result.add(new Field17G(tags[i].getValue()));
			}
			return result;
		}
	}
 ...
 */ 
	...
	public static class SequenceA extends SwiftTagListBlock {
		...
		*/
		public static final String[] TAIL = new String[]{ "81A", "81D", "81J", "89A", "89D", "89J", "77H", "14C"   };
	...
	*/ 
	...
	public static class SequenceB1 extends SwiftTagListBlock {
		...
		*/
		...
		/**
		* Last mandatory tagname of the sequence: <em>"53A", "53D", "53J"  </em>
		* Array format is for cases when more than one letter options is allowed
		*/
		public static final String[] END = { "53A", "53D", "53J"   };
		/**
		* List of optional tags after the last mandatory tag
		*/
		public static final String[] TAIL = new String[]{ "56A", "56D", "56J", "57A", "57D", "57J"   };
	...
	*/ 
	...
	public static class SequenceB2 extends SwiftTagListBlock {
 	...
 	/**
	* Get the single occurrence of SequenceB2 delimited by {@value SequenceB2#START} and {@value SequenceB2#END} .
	* The presence of this methods indicates that this sequence can occur only once according to the Standard.
	* If block 4 is empty this method returns <code>null</code>.
	*/ 
	...
	public static class SequenceC extends SwiftTagListBlock {
		...
		*/
		public static final String START_NAME =  "15C"  ;
	}
	...
	/**
	* Get the list of SequenceC1 delimited by  {@value SequenceC1#START} and {@value SequenceC1#END} 
	...
	*/
	public List<SequenceC1> getSequenceC1List() {
		...
		if (b4 != null && !b4.isEmpty()) {
			...
			final List<SwiftTagListBlock> bs = b4.getSubBlocksDelimitedWithOptionalTail(SequenceC1.START, SequenceC1.END, SequenceC1.TAIL); 
	...
	/**
	* Get the list of SequenceC1a delimited by  {@value SequenceC1a#START} and {@value SequenceC1a#END} 
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard. 
	* If message is empty or nor sequences are found <em>an empty list</em> is returned.
	* 
	*/
	public List<SequenceC1a> getSequenceC1aList() {
		...
		if (b4 != null && !b4.isEmpty()) {
			...
			final List<SwiftTagListBlock> bs = b4.getSubBlocksDelimitedWithOptionalTail(SequenceC1a.START, SequenceC1a.END, SequenceC1a.TAIL); 
			if (bs != null && !bs.isEmpty()) {
				for (final SwiftTagListBlock s : bs) {
	...
	public static class SequenceD extends SwiftTagListBlock {
		...
		*/
		...
		/**
		* Last mandatory tagname of the sequence: <em>"32G"  </em>
		* Array format is for cases when more than one letter options is allowed
		*/
		public static final String[] END = { "32G"   };
		/**
		* List of optional tags after the last mandatory tag
		*/
		public static final String[] TAIL = new String[]{  };
