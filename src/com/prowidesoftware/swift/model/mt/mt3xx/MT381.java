...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT381.class.getName());
	...
	/**
	 * Creates an MT381 initialized with a new SwiftMessage
	 */
	/*
	public MT381() {
		super();
