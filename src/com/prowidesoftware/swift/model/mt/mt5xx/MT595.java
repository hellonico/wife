...
public class MT595 extends AbstractMT implements Serializable {
	...
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT595.class.getName());
	...
	/**
	 * Creates an MT595 initialized with a new SwiftMessage
	 */
	public MT595() {
		super();
	}
