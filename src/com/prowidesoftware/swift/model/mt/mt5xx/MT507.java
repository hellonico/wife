...
// end qualifiers constants	
	...
	/**
	 * Creates an MT507 initialized with a new SwiftMessage
	 */
	/*
	public MT507() {
		super();
 ...
 */ 
	...
	*/
	...
	/**
	* Get the single occurrence of SequenceB1b delimited by 16R/16S {@value SequenceB1b#START_END_16RS}.
	* The presence of this methods indicates that this sequence can occur only once according to the Standard.
	* <em>NOTE: this method never returns <code>null</code>. If the sequence is not found an empty instance
	* of <code>SequenceB1b</code> is returned</em>  
	*/ 
	public SequenceB1b getSequenceB1b() {
		return new SequenceB1b(this.getSwiftMessage());
	}
