...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT576.class.getName());
	...
	/**
	 * Creates an MT576 initialized with a new SwiftMessage
	 */
	/*
	public MT576() {
		super();
 ...
 */ 
	...
	*/
	...
	/**
	* Get the list of SequenceB2b delimited by 16R/16S {@value SequenceB2b#START_END_16RS} 
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard.
	* If message is empty or nor sequences are found <em>an empty list</em> is returned.
	*/
	...
	/**
	* Get the list of SequenceB2c delimited by 16R/16S {@value SequenceB2c#START_END_16RS} 
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard.
	* If message is empty or nor sequences are found <em>an empty list</em> is returned.
	*/
	public List<SequenceB2c> getSequenceB2cList() {
		final List<SwiftTagListBlock> blocks = getSwiftMessage().getBlock4().getSubBlocks(SequenceB2c.START_END_16RS);
		if (blocks != null && !blocks.isEmpty()) {
			final List<SequenceB2c> result = new ArrayList<SequenceB2c>(blocks.size());
			for (final SwiftTagListBlock b:blocks) {
				result.add(new SequenceB2c(b));
			}
			return result; 
		}
		// TODO if is is mandatory issue a warning log
