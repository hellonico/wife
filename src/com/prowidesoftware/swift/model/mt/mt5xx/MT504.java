...
// end qualifiers constants	
	...
	/**
	 * Creates an MT504 initialized with a new SwiftMessage
	 */
	/*
	public MT504() {
		super();
 ...
 */ 
	...
	*/ 
	...
	/**
	* Get the single occurrence of SequenceC1a delimited by 16R/16S {@value SequenceC1a#START_END_16RS}.
	* The presence of this methods indicates that this sequence can occur only once according to the Standard.
	* <em>NOTE: this method never returns <code>null</code>. If the sequence is not found an empty instance
	* of <code>SequenceC1a</code> is returned</em>  
	*/ 
	public SequenceC1a getSequenceC1a() {
		return new SequenceC1a(this.getSwiftMessage());
	}
	...
	/**
	* Get the list of SequenceC1a1 delimited by 16R/16S {@value SequenceC1a1#START_END_16RS} 
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard.
	* If message is empty or nor sequences are found <em>an empty list</em> is returned.
	*/
	...
	*/ 
	...
	/**
	* Get the list of SequenceC2a1 delimited by 16R/16S {@value SequenceC2a1#START_END_16RS} 
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard.
	* If message is empty or nor sequences are found <em>an empty list</em> is returned.
	*/
