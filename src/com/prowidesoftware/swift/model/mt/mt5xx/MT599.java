...
public class MT599 extends AbstractMT implements Serializable {
	...
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT599.class.getName());
	...
	/**
	 * Creates an MT599 initialized with a new SwiftMessage
	 */
	public MT599() {
		super();
	}
