...
public class MT591 extends AbstractMT implements Serializable {
	...
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT591.class.getName());
	...
	/**
	 * Creates an MT591 initialized with a new SwiftMessage
	 */
	public MT591() {
		super();
	}
