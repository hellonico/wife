...
// end qualifiers constants	
	...
	/**
	 * Creates an MT513 initialized with a new SwiftMessage
	 */
	/*
	public MT513() {
		super();
 ...
 */ 
	...
	*/
	...
	/**
	* Get the list of SequenceC2 delimited by 16R/16S {@value SequenceC2#START_END_16RS} 
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard.
	* If message is empty or nor sequences are found <em>an empty list</em> is returned.
	*/
	...
	*/
	...
	/**
	* Get the list of SequenceD3 delimited by 16R/16S {@value SequenceD3#START_END_16RS} 
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard.
	* If message is empty or nor sequences are found <em>an empty list</em> is returned.
	*/
