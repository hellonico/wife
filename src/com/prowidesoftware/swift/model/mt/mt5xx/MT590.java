...
public class MT590 extends AbstractMT implements Serializable {
	...
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT590.class.getName());
	...
	/**
	 * Creates an MT590 initialized with a new SwiftMessage
	 */
	public MT590() {
		super();
	}
