...
public class MT596 extends AbstractMT implements Serializable {
	...
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT596.class.getName());
	...
	/**
	 * Creates an MT596 initialized with a new SwiftMessage
	 */
	public MT596() {
		super();
	}
