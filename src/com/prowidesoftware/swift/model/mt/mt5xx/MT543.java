...
// end qualifiers constants	
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT543.class.getName());
	...
	/**
	 * Creates an MT543 initialized with a new SwiftMessage
	 */
	/*
	public MT543() {
		super();
	...
	*/
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 12 at MT543 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 94C at MT543 is expected to be the only one.
	 * 
	 ...
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 94F at MT543 is expected to be the only one.
	 * 
