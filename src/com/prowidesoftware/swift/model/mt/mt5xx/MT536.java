...
// end qualifiers constants	
	...
	/**
	 * Creates an MT536 initialized with a new SwiftMessage
	 */
	/*
	public MT536() {
		super();
 ...
 */ 
	...
	*/ 
	...
	/**
	* Get the single occurrence of SequenceB1a2A delimited by 16R/16S {@value SequenceB1a2A#START_END_16RS}.
	* The presence of this methods indicates that this sequence can occur only once according to the Standard.
	* <em>NOTE: this method never returns <code>null</code>. If the sequence is not found an empty instance
	* of <code>SequenceB1a2A</code> is returned</em>  
	*/ 
	public SequenceB1a2A getSequenceB1a2A() {
		return new SequenceB1a2A(this.getSwiftMessage());
	}
