...
public class MT592 extends AbstractMT implements Serializable {
	...
	private static transient final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT592.class.getName());
	...
	/**
	 * Creates an MT592 initialized with a new SwiftMessage
	 */
	public MT592() {
		super();
	}
